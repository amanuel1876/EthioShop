...
const Shop = () => {
  ...
  const { data: filteredProductsData, isLoading: productsLoading } = useGetFilteredProductsQuery({
    checked,
    radio,
  });
  ...
  useEffect(() => {
    if (!checked.length || !radio.length) {
      if (filteredProductsData && !productsLoading) {
  ...
  }, [checked, radio, filteredProductsData, productsLoading, dispatch, priceFilter]);
  ...
  return (
    <div className="container mx-6">
      <div className="flex md:flex-row py-5">
        <div className="bg-[#151515] p-3 mt-2 mb-2 py-5">
          ...
          <h2 className="h4 text-center py-4 bg-black rounded-full mb-2">
            Filter by Brands
          </h2>
