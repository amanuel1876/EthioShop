...
const AdminDashboard = () => {
  ...
  const combinedLoading = isLoading || loading || loadingTwo;
        ...
        <div className="w-[80%] flex justify-around flex-wrap">
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            ...
            <h1 className="text-xl font-bold">
              {combinedLoading ? <Loader /> : `$ ${sales?.totalSales?.toFixed(2)}`}
            </h1>
          </div>
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-pink-500 text-center p-3"> $ </div>
            ...
            <h1 className="text-xl font-bold">
              {combinedLoading ? <Loader /> : customers?.length}
            </h1>
          </div>
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-pink-500 text-center p-3"> $ </div>
            ...
            <h1 className="text-xl font-bold">
              {combinedLoading ? <Loader /> : orders?.totalOrders}
            </h1>
          </div>
        </div>
